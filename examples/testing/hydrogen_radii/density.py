...
pdb = PDBFile( os.path.join(DATA_PATH, pdb_filename))
...
def npt(coords, velocities):
    ...
    # Set Simulation
    simulation = app.Simulation(pdb.topology, system, integrator, NPT_PLATFORM, NPT_PROPERTIES)
...
def production(coords, velocities, box):
    ...
    # Set Simulation
    simulation = app.Simulation(pdb.topology, system, integrator, PROD_PLATFORM, PROD_PROPERTIES)
